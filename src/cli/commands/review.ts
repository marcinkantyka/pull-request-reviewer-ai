/**
 * Review command - review current branch against base
 */
...
export function createReviewCommand(): Command {
  ...
  command
    .description('Review current branch against a base branch')
    ...
    .action(async (options: CLIOptions & { base?: string }) => {
      try {
        ...
        let diffs = await gitRepo.getBranchDiff(baseBranch, config.git.maxDiffSize);
